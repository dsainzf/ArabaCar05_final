<%-- 
    Document   : PasajeroLogueado
    Created on : 07-jun-2021, 19:40:03
    Author     : imano
--%>
...
<html>
    ...
    <body>
        <div id="contenedor">
            <a title="logo" href="PasajeroLogueado.jsp"><img id="logo" src="images/ArabaCar05.png" alt="logo" height="53"/></a>
            <nav id="navegador">
                <p id="saludo"><%=n%> </p>
                <ul>
